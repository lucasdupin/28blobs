...
void MainApp::draw(){
	...
	ofDrawBitmapString(ofToString(ofGetFrameRate(), 0) + "FPS, F to toggle fullscreen, B for background or G for gui, S to save, V to show all hidden cameras", 10, ofGetHeight()-15);
